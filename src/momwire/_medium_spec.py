...
_REFUSE_CONTACT_WITH_BURIED = (
    ...
    "sigma 0.005 S/m, 7 MHz): the continuation-consistent spelling still "
    "misses (the margin is under re-derivation at the matched feed - "
    "momwire#706, momwire#567) and the residual is the spreading current "
    "itself, "
