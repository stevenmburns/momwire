...
_REFUSE_BURIED_WITH_CONTACT = (
    ...
    "this engine's own prints for these decks - 92.130 - 70.141j ohm for a "
    "10 m monopole over one detached 5 m radial 15 cm down, 90.051 - "
    "70.731j ohm for the four-radial fan, both over eps_r 13 / sigma 0.005 "
    "S/m soil at 7 MHz - and the closest still misses (the margin is under "
    "re-derivation at the matched feed - momwire#706, momwire#567), because the "
