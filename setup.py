...
# The accelerator uses GCC-only flags (-fopenmp, -mavx2, -lmvec). On Windows
# (MSVC) the build fails; triangular.py already falls back to pure Python if
# the import is missing, so skip the extension there.
