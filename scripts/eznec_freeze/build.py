...
def main() -> int:
    ...
    (bundle / "README.txt").write_text(
        ...
        f"{table}\n"
        "\n"
        "WHICH ONE.  The default is momwire's own degree-2 B-spline basis.\n"
        "momwire-eznec-razor-nec5 is the NEC-5 formulation twin — the tent\n"
        "basis with razor-blade path testing that NEC-5 itself uses — so it\n"
        "is the one that reproduces the licensed engine most closely.  They\n"
        "accept the same models; they answer in different formulations.\n"
        "\n"
