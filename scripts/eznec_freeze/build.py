...
def main() -> int:
    ...
    (bundle / "README.txt").write_text(
        ...
        "\n"
        "Which is nearer the truth is a different question, and it is asked\n"
        "by scoring each basis against ITS OWN converged answer (even meshes,\n"
        "feed on the centre knot, reference at 320 segments):\n"
        "\n"
        "    segments   bs2 error   razor-nec5 error\n"
        "        4       1.54 ohm      80.63 ohm\n"
        "       20       0.39 ohm       7.16 ohm\n"
        "      240       0.025 ohm      0.17 ohm\n"
        "\n"
        "Both converge; at a matched mesh the B-spline basis is 20-50x nearer\n"
        "its own limit.  Neither is converged at a coarse mesh -- bs2 is\n"
        "still 1.5 ohm out at four segments -- the difference is how fast the\n"
        "error falls.\n"
        "\n"
