"""Probe 14 (momwire#1149 U2): the scoping's probe 12 contrast law re-run
with the U2 node term, verbatim otherwise (same deck, mesh, cases). The
licensed reference is an instrument here, a black box verified against our
licensed materials.

Scoping's probe 12 header follows.
